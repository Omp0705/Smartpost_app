...
import com.om.smartpost.customer.home.presentation.CustomerHomeScreen
import com.om.smartpost.postman.home.presentation.PostmanHomeScreen
            ...
            composable(NavRoutes.SIGN_IN) {
                ...
                SignInScreen(
                    ...
                    onNavigateToPostmanHome = {
                        navController.navigate(NavRoutes.POSTMAN_HOME){
                            popUpTo(NavRoutes.AUTH) {inclusive = true}
                        }
                    }
                )
